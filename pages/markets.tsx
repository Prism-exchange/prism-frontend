...
import { findPriceByPair } from '../utils/find'
...
const markets = (props: Props) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center ">
      <div className="w-full justify-center items-center py-1 px-2 sm:px-4 sm:py-2 bg-white">
        <div className="text-black flex text-xs lg:text-sm justify-center items-center gap-3">
              ...
              <div className="flex flex-row gap-14 items-center justify-center ">
                <div className="flex felx-row items-center justify-center gap-2">
                  ...
                  <div className="flex flex-col">
                    ...
                    <h1 className="text-sm textGray">pBTC-pUSDT</h1>
                  </div>
                </div>
                <div>
                  <h1 className="font-semibold text-xl ">
                    ${findPriceByPair(listPairOrder, 'pBTC-pUSDT')}
                  </h1>
                </div>
              </div>
              ...
              <div className="flex flex-row gap-14 items-center justify-center ">
                <div className="flex felx-row items-center justify-center gap-2">
                  ...
                  <div className="flex flex-col">
                    ...
                    <h1 className="text-sm textGray">WETH-USDT</h1>
                  </div>
                </div>
                <div>
                  <h1 className="font-semibold text-xl ">
            ...
            <div className="flex flex-col p-5 bg-[#1F2937] text-white rounded-xl gap-5    lg:w-auto md:w-2/5 w-3/5 ">
              <div className="flex flex-row gap-14 items-center justify-center ">
                <div className="flex felx-row items-center justify-center gap-2">
                  ...
                  />
                  <div className="flex flex-col">
                    <h1 className="font-semibold ">Prism</h1>
                    <h1 className="text-sm textGray">PRISM-USDT</h1>
                  </div>
                </div>
                <div>
                  <h1 className="font-semibold text-xl ">
                    ${findPriceByPair(listPairOrder, 'PRISM-pUSDT')}
                  </h1>
                </div>
              </div>
              <div className="flex flex-row gap-3  items-center ">
        ...
        <div className="flex flex-row items-center justify-between mb-5">
          <div className="flex gap-5  items-center">
            <span className="flex gap-1 Buttonselect  cursor-default py-2 max-w-fit items-center">
              Blast Sepolia
              <img src="/blast.png" alt="" className="lg:w-6 lg:h-6 w-4 h-4" />
            </span>
